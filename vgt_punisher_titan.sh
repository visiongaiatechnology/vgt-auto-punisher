#!/bin/bash
# ==============================================================================
# VISIONGAIA TECHNOLOGY: AUTO-PUNISHER (V3.1 - SOVEREIGN EDITION)
# STATUS: DIAMANT VGT SUPREME
# LICENCE: AGPLv3 (Affero General Public License)
# NOTE: "Das Tool ist für Menschen, nicht für SaaS Unternehmen."
# ZWECK: Automatisches Verhaltens-basiertes Blockieren (IPv4 & IPv6 Kernel Drop)
...
echo -e "${C_CYAN}   VGT AUTO-PUNISHER - SOVEREIGN OS EDITION (V3.1)                          ${C_RESET}"
...
echo -e "   ${C_GRAY}Licence:${C_RESET}   AGPLv3 - For Humans, not for SaaS Corporations."
echo -e "${C_PURPLE}----------------------------------------------------------------------------${C_RESET}"
